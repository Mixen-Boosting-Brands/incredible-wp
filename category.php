    ...
    <div class="container">
        ...
        <?php if ( category_description() ) : ?>
            <div class="archive-description">
                <?php echo category_description(); // phpcs:ignore WordPress.Security.EscapeOutput ?>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<section class="pb-60">
    <div class="container">
        ...
        <?php else : ?>
            <p class="text-center mb-0">No se encontraron publicaciones en esta categoría.</p>
        <?php endif; ?>
    </div>
</section>
